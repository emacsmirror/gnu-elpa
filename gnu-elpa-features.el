...
(fn SYMBOL &optional POINT ONLY-OVERLAY)" nil nil)
	     (auto-overlay-highest-priority-at-point "Return highest priority overlay at POINT, defaulting to the point.
...
(fn &optional POINT &rest PROP-TESTS &key INACTIVE ALL-OVERLAYS &allow-other-keys)" nil nil)
	     (auto-overlays-at-point "Return overlays overlapping POINT, defaulting to the point.
...
(fn &optional ARG)" t nil)
	     (context-coloring-js2-colorize "Color the buffer using the `js2-mode'." nil nil)
	     (context-coloring-eval-expression-predicate "Non-nil if the minibuffer is for `eval-expression'." nil nil)
	     (context-coloring-eval-expression-colorize "Color the `eval-expression' minibuffer prompt as elisp." t nil)
	     (context-coloring-elisp-colorize "Color the current Emacs Lisp buffer." t nil)
...
(fn)" t nil)
	     (cpio-discern-archive-type "Return a symbol reflecting the type of the cpio archive in the current buffer.
...
or nil if the current buffer does not begin with a cpio entry header." nil nil)
	     (cpio-mode-find-file-hook "find-file hook to detect if a file is likely a cpio archive.
...
(fn &optional ARG)" t nil)
	     (diff-hl--global-turn-on "Call `turn-on-diff-hl-mode' if the current major mode is applicable." nil nil)
...
This is useful for reading patches from mailing lists." t nil)
	     (diffview-region "Show current diff region in a side-by-side view." t nil)
	     (diffview-current "Show current diff buffer in a side-by-side view." t nil)
...
(fn &optional N)" t nil)
	     ...
	     (gnorb-ebdb-link-id "Access slot \"id\" of `gnorb-ebdb-link' struct X.

(fn X)" nil nil)
	     (gnorb-ebdb-link-group "Access slot \"group\" of `gnorb-ebdb-link' struct X.

(fn X)" nil nil)
	     (gnorb-ebdb-link-date "Access slot \"date\" of `gnorb-ebdb-link' struct X.

(fn X)" nil nil)
	     (gnorb-ebdb-link-subject "Access slot \"subject\" of `gnorb-ebdb-link' struct X.
...
(fn MANAGED-MAJOR-MODE PROJECT CLASS CONTACT &optional INTERACTIVE)" t nil)
	     (eldoc-eval-expression "Eval expression with eldoc support in mode-line." t nil)
...
(fn OLD)" nil nil)
	     (ggtags-build-imenu-index "A function suitable for `imenu-create-index-function'." nil nil)
...
(fn &optional ARG)" t nil)
	     (turn-off-hes-mode "Turn off highlighting of escape sequences" t nil)
	     (turn-on-hes-mode "Turn on highlighting of escape sequences." t nil)
...
(fn NAME BODY &optional DOCSTRING &rest HEADS)" nil t)
	     (ivy-switch-buffer-other-window "Switch to another buffer in another window." t nil)
	     (ivy-switch-view "Switch to one of the window views stored by `ivy-push-view'." t nil)
...
(fn &optional ARG)" t nil)
	     (ivy-completing-read "Read a string in the minibuffer, with completion.
...
(fn)" t nil)
	     (js2-jsx-mode "Major mode for editing JSX code in Emacs 26 and earlier.
...
(fn &optional ARG)" t nil)
	     (kiwix-at-point "Search for the symbol at point with `kiwix-query'." t nil)
...
(fn PARG)" t nil)
	     (landmark-test-run "Run 100 Landmark games, each time saving the weights from the previous game." t nil)
	     (leaf "Symplify your `.emacs' configuration for package NAME with ARGS.

(fn NAME &rest ARGS)" nil t)
	     (leaf-key-describe-bindings "Display all the bindings configured via `leaf-key'." t nil)
...
(fn)" t nil)
	     (notes-underline-line "* Create a row of dashes as long as this line, or adjust the current underline." t nil)
...
(fn KEY)" t nil)
	     (paced-load-all-dictionaries "Load all dictionaries in `paced-dictionary-directory'." t nil)
...
(fn &optional ARG)" t nil)
	     (rm--mode-list-as-string-list "Return `minor-mode-list' as a simple list of strings." nil nil)
...
(fn &optional ARG)" t nil)
	     (shell-command+ "Intelligently execute string COMMAND in inferior shell.
...
(fn &optional BUFFER)" t nil)
	     (sqlind-setup-style-default "Define an sql-indentation style where keywords are right aligned." t nil)
	     (sqlind-setup-style-right "Define an sql-indentation style where keywords are right aligned." t nil)
	     (sqlind-setup-style-left "Define an sql-indentation style where keywords are left aligned." t nil)
...
(fn &optional SIZE FOREGROUND BACKGROUND OFFSET NO-SECONDS NO-FACE)" nil nil)
	     (swiper-isearch-backward "Like `swiper-isearch' but the first result is before the point.
...
(fn &optional INITIAL-INPUT)" t nil)
	     (swiper-all-thing-at-point "`swiper-all' with `ivy-thing-at-point'." t nil)
...
(fn &optional ARG)" t nil)
	     (vlf-occur-load "Load serialized `vlf-occur' results from current buffer." t nil)
...
(fn &optional ARG)" t nil)
	     (ztree-view-on-window-configuration-changed "Hook called then window configuration changed to resize buffer's contents" nil nil)
...
(defconst gnu-elpa--autoloads-table '(("ace-" . "ace-window") ("ack" . "ack") ("adaptive-wrap-prefix-mode" . "adaptive-wrap") ("adjust-parens-mode" . "adjust-parens") ("advice-patch" . "advice-patch") ("aggressive-indent-" . "aggressive-indent") ("all" . "all") ("ampc" . "ampc") ("arbitools-mode" . "arbitools") ("aa2u" . "ascii-art-to-unicode") ("async-" . "async") ("aumix" . "aumix-mode") ("auto-correct-" . "auto-correct") ("auto-overlay" . "auto-overlays") ("pcomplete/a" . "ack") ("provide-me" . "load-relative") ("pabbrev-mode" . "pabbrev") ("paced-" . "paced") ("phps-mode-" . "phps-mode") ("pinentry-start" . "pinentry") ("poker" . "poker") ("posframe-" . "posframe") ("pspp-mode" . "pspp-mode") ("global-aggressive-indent-mode" . "aggressive-indent") ("global-captain-mode" . "captain") ("global-compact-docstrings-mode" . "compact-docstrings") ("global-diff-hl-" . "diff-hl") ("global-nlinum-mode" . "nlinum") ("global-num3-mode" . "num3-mode") ("global-pabbrev-mode" . "pabbrev") ("global-quarter-plane-mode" . "quarter-plane") ("global-undo-tree-mode" . "undo-tree") ("gle-mode" . "gle-mode") ("gnorb-ebdb-link-" . "ebdb-gnorb") ("gnome-c-" . "gnome-c-style") ("gnu-elpa-keyring-update" . "gnu-elpa-keyring-update") ("gnugo" . "gnugo") ("gnus-mock-" . "gnus-mock") ("gcmh-mode" . "gcmh") ("ggtags-" . "ggtags") ("gited-list-branches" . "gited") ("gpastel-mode" . "gpastel") ("greader-" . "greader") ("greenbar-mode" . "greenbar") ("guess-language-mode" . "guess-language") ("gst" . "smalltalk-mode") ("dired-async-" . "async") ("dired-du-" . "dired-du") ("dired-git-info-" . "dired-git-info") ("dictree-" . "dict-tree") ("diff-hl-" . "diff-hl") ("diffview-" . "diffview") ("disk-usage" . "disk-usage") ("dismal-mode" . "dismal") ("darkroom-" . "darkroom") ("dbus-codegen-" . "dbus-codegen") ("delight" . "delight") ("define-hook-" . "hook-helpers") ("define-namespace" . "names") ("defhydra" . "hydra") ("djvu-" . "djvu") ("docbook-find-file" . "docbook") ("dts-mode" . "dts-mode") ("beacon-" . "beacon") ("bluetooth-list-devices" . "bluetooth") ("bnf-mode" . "bnf-mode") ("brief-" . "brief") ("buffer-expose" . "buffer-expose") ("bug-hunter-" . "bug-hunter") ("caps-lock-mode" . "caps-lock") ("captain-mode" . "captain") ("chess" . "chess") ("clipboard-collector-" . "clipboard-collector") ("cobol-mode" . "cobol-mode") ("coffee-mode" . "coffee-mode") ("compact-docstrings-mode" . "compact-docstrings") ("company-ebdb" . "company-ebdb") ("company-math-symbols-" . "company-math") ("company-latex-commands" . "company-math") ("company-statistics-mode" . "company-statistics") ("context-coloring-" . "context-coloring") ("copy-gnorb-ebdb-link" . "ebdb-gnorb") ("cpio-" . "cpio-mode") ("crisp-mode" . "crisp") ("create-hook-helper" . "hook-helpers") ("csv-mode" . "csv-mode") ("cycle-quotes" . "cycle-quotes") ("tsv-mode" . "csv-mode") ("turn-on-diff-hl-mode" . "diff-hl") ("turn-on-hes-mode" . "highlight-escape-sequences") ("turn-off-hes-mode" . "highlight-escape-sequences") ("tNFA-" . "tNFA") ("temp-buffer-browse-" . "temp-buffer-browse") ("test-simple-" . "test-simple") ("tf-" . "timerfunctions") ("timerfunctions-introduction" . "timerfunctions") ("tiny-" . "tiny") ("transcribe-mode" . "transcribe") ("read-dict" . "dict-tree") ("require-relative" . "load-relative") ("register-list" . "register-list") ("relint-" . "relint") ("repology" . "repology") ("rails-routes-find" . "rails-routes") ("rainbow-mode" . "rainbow-mode") ("rcirc-menu" . "rcirc-menu") ("rich-minority-mode" . "rich-minority") ("rm--mode-list-as-string-list" . "rich-minority") ("rnc-mode" . "rnc-mode") ("make-dictree" . "dict-tree") ("make-heap" . "heap") ("markchars-" . "markchars") ("memory-usage" . "memory-usage") ("metar" . "metar") ("midikbd-open" . "midi-kbd") ("mines" . "mines") ("minibuffer-line-mode" . "minibuffer-line") ("minimap-mode" . "minimap") ("mmm-add-classes" . "mmm-mode") ("multishell-" . "multishell") ("log-session-mode" . "dismal") ("load-dirs" . "load-dir") ("load-relative" . "load-relative") ("loccur" . "loccur") ("landmark" . "landmark") ("leaf" . "leaf") ("lex-" . "lex") ("lmc-asm-mode" . "lmc") ("easy-" . "easy-kill") ("ediprolog-" . "ediprolog") ("eev-beginner" . "eev") ("eglot" . "eglot") ("eldoc-" . "eldoc-eval") ("electric-spacing-mode" . "electric-spacing") ("elisp-benchmarks-run" . "elisp-benchmarks") ("enwc" . "enwc") ("epoch-view-mode" . "epoch-view") ("exco" . "excorporate") ("er/expand-region" . "expand-region") ("filladapt-mode" . "filladapt") ("find-file-noselect-relative" . "load-relative") ("frame-tabs-mode" . "frame-tabs") ("frog-menu-" . "frog-menu") ("hes-mode" . "highlight-escape-sequences") ("html-erb-mode" . "mmm-mode") ("nxml-html5-dt-compile" . "html5-schema") ("nxml-web-mode" . "mmm-mode") ("nameless-mode" . "nameless") ("nhexl-mode" . "nhexl-mode") ("nlinum-mode" . "nlinum") ("notes-" . "notes-mode") ("num3-mode" . "num3-mode") ("ivy-switch-" . "ivy") ("ivy-mode" . "ivy") ("ivy-completing-read" . "ivy") ("ivy-re" . "ivy") ("ivy-explorer-mode" . "ivy-explorer") ("ivy-posframe-mode" . "ivy-posframe") ("inferior-shen" . "shen-mode") ("javaimp-" . "javaimp") ("jgraph-mode" . "jgraph-mode") ("js2-" . "js2-mode") ("json-mode" . "json-mode") ("jumpc" . "jumpc") ("org-kiwix-setup-link" . "kiwix") ("org-edna-" . "org-edna") ("orgalist-mode" . "orgalist") ("oauth2-" . "oauth2") ("omn-mode" . "omn-mode") ("on-screen-" . "on-screen") ("osc-" . "osc") ("other-frame-window-mode" . "other-frame-window") ("kiwix-" . "kiwix") ("with-relative-file" . "load-relative") ("windresize" . "windresize") ("wisitoken-grammar-mode" . "wisitoken-grammar-mode") ("wcheck-" . "wcheck-mode") ("wconf-" . "wconf") ("ws-start" . "web-server") ("webfeeder-" . "webfeeder") ("__FILE__" . "load-relative") ("style-format" . "psgml") ("sgml-mode" . "psgml") ("scroll-restore-mode" . "scroll-restore") ("sed-mode" . "sed-mode") ("shelisp-mode" . "shelisp") ("shell-command+" . "shell-command+") ("shen-mode" . "shen-mode") ("sisu-mode" . "sisu-mode") ("slime-volleyball" . "slime-volleyball") ("sm-c-mode" . "sm-c-mode") ("smalltalk-mode" . "smalltalk-mode") ("smart-yank-mode" . "smart-yank") ("sml-" . "sml-mode") ("sokoban" . "sokoban") ("speed-of-thought-" . "sotlisp") ("spinner-" . "spinner") ("sql-beeline" . "sql-beeline") ("sqlind-" . "sql-indent") ("svg-clock" . "svg-clock") ("swiper" . "swiper") ("snippet-mode" . "yasnippet") ("xml-mode" . "psgml") ("xclip-mode" . "xclip") ("xpm-" . "xpm") ("xr" . "xr") ("quarter-plane-mode" . "quarter-plane") ("undo-tree-mode" . "undo-tree") ("uniq-file-read" . "uniquify-files") ("url-ntlm-auth" . "url-http-ntlm") ("validate-" . "validate") ("valign-" . "valign") ("vcard-" . "vcard") ("vcl-mode" . "vcl-mode") ("vdiff-" . "vdiff") ("vigenere-" . "vigenere") ("visual-fill-mode" . "visual-fill") ("vlf" . "vlf") ("100secwp" . "wpuzzle") ("yas-" . "yasnippet") ("ztree" . "ztree")))

;; Local Variables:
